...
const popupOpts = [{
    ...
    html: `Первая в Китае коммерческая автономная распределенная система графов с независимыми правами на интеллектуальную собственность. <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://sbercloud.ru/ru/products/graph-engine-service-ges">Подробнее</a>`
}, {
    selector: "document-database-popup",
    html: `Предоставляет собой сервис управления документоориентированной базой данных, полностью совместимой с MongoDB. <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://sbercloud.ru/ru/products/document-database-service-mongodb">Подробнее</a>`
}, {
    selector: "distributed-cache-popup",
    html: `Высокопроизводительный распределенный сервис кэширования данных в памяти. <br /> <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://sbercloud.ru/ru/products/distributed-cache-service-for-memcached">For Memcached</a> <br /> <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://sbercloud.ru/ru/products/distributed-cache-service-for-redis">For Redis</a>`
}, {
    selector: "relational-database-popup",
    html: `Сервис управления реляционными базами данных. <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://sbercloud.ru/ru/products/relational-databases-service">Подробнее</a>`
}, {
...
}, 
{
    ...
    html: `Прохождение в буткемп программы акселератора Sber500`
}, 
{
    ...
    html: `Топовые футболки и кружки с символикой хакатона`
}, {
    ...
    html: `Напишите нам в <a class="tooltip-link" rel="noopener noreferrer" target="_self" href="https://t.me/joinchat/CN0_CRu4NI1L0DStXsp_dw">чат хакатона</a> - будем рады ответить на вопросы и помочь.`
}];
